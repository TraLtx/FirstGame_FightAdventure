...
public class Item_Power : ShopItem
{
    protected static Item_Power instance;
    public static Item_Power Instance {get => instance;}
    ...
    protected override void InitData(){
        ...
        this.levelMax = 5;
        Debug.Log("InPowerClass_Init: LeveMax-"+this.levelMax+", Level-"+this.level);
